...
import "./HistoryTestResultModal.css";
import IrregularVerbService from "../service/IrregularVerbService";

const HistoryTestResultModal = ({ isVisible, onClose, historyId }) => {
    ...
    useEffect(() => {
        if (historyId) {
          IrregularVerbService.getProgressHistoryAnswers(historyId).then((r) => {
...
export default HistoryTestResultModal;
